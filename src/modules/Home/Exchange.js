   ...
   return(
    <div id="hs_cos_wrapper_homepage_product_overview" className="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_module" data-hs-cos-general-type="widget" data-hs-cos-type="module">
      <section id="free-crm-tabs-section" 
        className="free-crm-tabs-section -dark -background-01"><div class="free-crm-tabs-section-wrapper"><div id="free-crm-tabs" class="cl-tabs free-crm-tabs"><div class="cl-tab-control -overflow-right"><ul class="cl-tab-list" role="tablist"><li class="cl-tab-item"><button class="cl-tab-button" id="tab-free-crm__persona-tab_1" aria-selected="true"> همه دسته ها </button></li><li class="cl-tab-item"><button class="cl-tab-button" aria-selected="">ایده‌پردازی و برنامه‌ریزی </button></li><li class="cl-tab-item " role="presentation"><button class="cl-tab-button" aria-selected=""> تحقیق و توسعه محتوا </button></li><li class="cl-tab-item " role="presentation"><button class="cl-tab-button" aria-selected=""> تولید محتوا </button></li><li class="cl-tab-item " role="presentation"><button class="cl-tab-button" aria-selected=""> ویرایش و بهینه‌سازی </button></li><li class="cl-tab-item " role="presentation"><button class="cl-tab-button" aria-selected=""> توزیع و انتشار</button></li></ul>
        </div>
        </div></div></section>
